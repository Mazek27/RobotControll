package pl.mazek.robotcontroll.Solver;

/**
 * Created by Mazek on 20.12.2016.
 */
public class CoordCube {
    static final short N_TWIST = 2187;// 3^7 możliwych kierunków krawedzi
    static final short N_FLIP = 2048;// 2^11 możliwych obrotów rogów
    static final short N_SLICE1 = 495;// 12 wybranych na  4 mozliwych pozycji z FR,FL,BL,BR krawedzi
    static final short N_SLICE2 = 24;// 4! permutacji z FR,FL,BL,BR rogów w phase2
    static final short N_PARITY = 2; // 2 possible corner parities
    static final short N_URFtoDLF = 20160;// 8!/(8-6)! permutacji z URF,UFL,ULB,UBR,DFR,DLF krawedzi
    static final short N_FRtoBR = 11880; // 12!/(12-4)! permutacji z FR,FL,BL,BR rogów
    static final short N_URtoUL = 1320; // 12!/(12-3)! permutacji z UR,UF,UL rogów
    static final short N_UBtoDF = 1320; // 12!/(12-3)! permutacji z UB,DR,DF rogów
    static final short N_URtoDF = 20160; // 8!/(8-6)! permutacji z UR,UF,UL,UB,DR,DF rogów w phase2

    static final int N_URFtoDLB = 40320;// 8! permutacji z krawedzi
    static final int N_URtoBR = 479001600;// 8! permutacji z krawedzi

    static final short N_MOVE = 18;

    // Wszystkie koordynaty są 0 dla rozwiazanej kostki z wyjatkiem dla UBtoDF, który jest 114
    short twist;
    short flip;
    short parity;
    short FRtoBR;
    ...
    /**
     * CONSTRUCT
     * Generuje CoordCube na podstawie CubieCube
     */
    CoordCube(CubieCube c) {
        ...
        URtoUL = c.getURtoUL();
        UBtoDF = c.getUBtoDF();
        URtoDF = c.getURtoDF();// potrzebne tylko przy phase2
    }
